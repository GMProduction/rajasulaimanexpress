                            ...
                            <div class="form-floating w-100 mb-3">
                                ...
                                <select class="select2" name="province" id="province" style="width: 100%;">
                                    @foreach($provinces as $v)
                                        <option value="{{ $v->id }}" {{ $data->province_id == $v->id ? 'selected' : '' }}>{{ $v->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="name" name="name" placeholder="Nama Kota" value="{{ $data->name }}">
