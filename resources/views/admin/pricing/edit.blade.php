                            ...
                            <div class="form-floating w-100 mb-3">
                                ...
                                <select class="select2" name="platform" id="platform" style="width: 100%;">
                                    @foreach($platform as $v)
                                        <option value="{{ $v->id }}" {{ $data->platform_id == $v->id ? 'selected' : '' }}>{{ $v->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-floating w-100 mb-3">
                                ...
                                <select class="select2" name="origin" id="origin" style="width: 100%;">
                                    ...
                                    @foreach($cities as $v)
                                        <option value="{{ $v->id }}" {{ $data->origin_id == $v->id ? 'selected' : '' }}>{{ $v->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-floating w-100 mb-3">
                                ...
                                <select class="select2" name="destination" id="destination" style="width: 100%;">
                                    ...
                                    @foreach($cities as $v)
                                        <option value="{{ $v->id }}" {{ $data->destination_id == $v->id ? 'selected' : '' }}>{{ $v->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control" id="min_weight" name="min_weight" value="{{ $data->min_weight }}">
